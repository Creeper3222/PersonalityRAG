...
The independent service removes AstrBot-specific event hooks, LLM summarization,
LLM tools and plugin-page bridge integration. It preserves compatible data
structures and retrieval behaviour to support migration of existing user data.
